...
public class PathFinder {
	...
	private ArrayList<Node> fechado = new ArrayList<Node>();
	...
	// Construtor sem heuristica
	public PathFinder(TileBasedMap mapa, int distanciaMaxima, boolean movimentoDiagonal) {
		this(mapa, distanciaMaxima, movimentoDiagonal, new Heuristica());
	}

	// Construtor com heuristica
	public PathFinder(TileBasedMap mapa, int distanciaMaxima, boolean movimentoDiagonal, Heuristica heuristica) {
	...
	// Encontra o caminho
	public synchronized Caminho findPath(int mover, int sx, int sy, int tx, int ty) {
